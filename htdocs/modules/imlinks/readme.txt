...
To test if the above code is working you can test it by passing the website url or an url to an imLinks link to the Facebook Debugger: http://developers.facebook.com/tools/debug
