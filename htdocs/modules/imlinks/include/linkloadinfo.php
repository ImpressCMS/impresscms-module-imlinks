...
if ( icms_userIsAdmin() == true && $moderate == 0 ) {
	$imlink['adminlink'] = '<a href="' . ICMS_URL . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/admin/links.php"><img src="' . ICMS_URL . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/images/icon/computer.png" alt="" title="' . _MD_IMLINKS_ADMINSECTION . '" style="vertical-align: bottom;" /></a>&nbsp;';
	$imlink['adminlink'] .= '<a href="' . ICMS_URL . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/admin/links.php?op=edit&amp;lid=' . $link_arr['lid'] . '"><img src="' . ICMS_URL . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/images/icon/world_edit.png" alt="" title="' . _EDIT . '" style="vertical-align: bottom;" /></a>&nbsp;';
	$imlink['adminlink'] .= '<a href="' . ICMS_URL . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/admin/links.php?op=delete&amp;lid=' . $link_arr['lid'] . '"><img src="' . ICMS_URL . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/images/icon/world_delete.png" alt="" title="' . _DELETE . '" style="vertical-align: bottom;" /></a>&nbsp;';
	$imlink['adminlink'] .= '<a href="' . ICMS_URL . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/admin/links.php?op=clone&amp;lid=' . $link_arr['lid'] . '"><img src="' . ICMS_URL . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/images/icon/world_clone.png" alt="" title="' . _CLONE . '" style="vertical-align: bottom;" /></a>&nbsp;';
	$imlink['adminlink'] .= '<a href="http://whois.domaintools.com/' . $whoisurl . '" target="_blank"><img src="' . ICMS_URL . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/images/icon/domaintools.png" alt="" title="WHOIS" style="vertical-align: bottom;" /></a>';
} else {
