...
class mod_imlinks_Broken extends icms_ipf_seo_Object {
	...
	function getIgnoreBroken() {
		$ret = '<a href="../admin/brokenlink.php?op=ignoreBrokenlinks&amp;lid=' . $this -> getVar( 'lid' ) . '"><img src="../images/icon/cross.png" alt="" title="' . _AM_IMLINKS_BIGNORE . '" /></a>';
		return $ret;
	}
	...
	function getDeleteBroken() {
		$ret = '<a href="../admin/brokenlink.php?op=delBrokenlinks&amp;lid=' . $this -> getVar( 'lid' ) . '"><img src="../images/icon/world_delete.png" alt="" title="' . _AM_IMLINKS_ICO_DELETE . '" /></a>';
		return $ret;
	}
	...
	function Acknowledged() {
		...
		$ret = '<a href="../admin/brokenlink.php?op=changeacknowledged&amp;reportid=' . $this -> getVar( 'reportid' ) . '"><img src="../images/icon/' . $ack_image . '.png" alt="" title="' . _AM_IMLINKS_ICO_ACK . '" /></a>';
		return $ret;
	}
	...
	function Confirmed() {
		...
		$ret = '<a href="../admin/brokenlink.php?op=changeconfirmed&amp;reportid=' . $this -> getVar( 'reportid' ) . '"><img src="../images/icon/' . $con_image . '.png" alt="" title="' . _AM_IMLINKS_ICO_ACK . '" /></a>';
		return $ret;
	}
