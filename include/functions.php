...
function wfl_serverstats() {
    echo "<fieldset style='border: #e8e8e8 1px solid;'><legend style='display: inline; font-weight: bold; color: #0A3760;'>" . _AM_WFL_LINK_IMAGEINFO . "</legend>\n
...
function wfl_adminmenu( $header = '', $menu = '', $extra = '', $scount = 4 ) {
    ...
    if ( empty( $menu ) ) {
        ...
        $menu = array(
            ...
            _AM_WFL_MLINKS => "index.php?op=edit",
            _AM_WFL_MUPLOADS => "upload.php",
            _AM_WFL_MVOTEDATA => "votedata.php",
            _AM_WFL_MLISTPINGTIMES => "index.php?op=pingtime",
...
//    }
    ...
    $icon = "<a href='index.php?op=edit&amp;lid=" . $lid . "' title='" . _AM_WFL_ICO_EDIT . "'>" . $imagearray['editimg'] . "</a>&nbsp;";
    $icon .= "<a href='index.php?op=delete&amp;lid=" . $lid . "' title='" . _AM_WFL_ICO_DELETE . "'>" . $imagearray['deleteimg'] . "</a>&nbsp;";
