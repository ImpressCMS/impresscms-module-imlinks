...
* @since		1.00
* @author		McDonald
* @version		$Id: main.php 23577 2012-02-16 21:40:11Z mcdonald3072 $ Russian translation. Charset: utf-8 (without BOM)
*/
...
define( "_MD_IMLINKS_RATINGHTOL", "Оценка (по убыванию)" );
...
define( "_MD_IMLINKS_POPULARITY", "Популярные" );
...
define( "_MD_IMLINKS_LAST30DAYS", "Последние 30 дней" );
define( "_MD_IMLINKS_1WEEK", "1 неделя" );
define( "_MD_IMLINKS_2WEEKS", "2 недели" );
define( "_MD_IMLINKS_30DAYS", "30 дней" );
define( "_MD_IMLINKS_SHOW", "Показать" );
define( "_MD_IMLINKS_DAYS", "дней" );
define( "_MD_IMLINKS_NEWLINKS", "Новые ссылки" );
...
define( "_MD_IMLINKS_DISPLAYING", "Отсортировано по колонке: " );
define( "_MD_IMLINKS_LEGENDTEXTNEW", "Новые сегодня" );
...
// added by McDonald
define( "_MD_IMLINKS_COUNTRY", "Страна:" );
...
define( "_MD_IMLINKS_INFORMATION", "Информация" );
define( "_MD_IMLINKS_ADDRESS", "Подробности для контактов:" );
...
define( "_MD_IMLINKS_STREET1", "Улица 1" );
define( "_MD_IMLINKS_STREET2", "Улица 2 (опционально)" );
define( "_MD_IMLINKS_TOWN", "Город" );
define( "_MD_IMLINKS_STATE", "Область" );
define( "_MD_IMLINKS_ZIPCODE", "Почтовый индекс" );
...
define( "_MD_IMLINKS_VATWIKI", 'Подробности смотрите на <a href="http://en.wikipedia.org/wiki/Value_added_tax_identification_number" target="_blank">Wikipedia</a>' );
...
define( '_MD_IMLINKS_COUNTRYDSC', 'Если страна не выбрана, адрес не может быть отформатирован и не будет отображаться.' );
define( '_MD_IMLINKS_MAPDSC', 'Кликните на иконку для показа карты в новой закладке или окне браузера.<br />По умолчанию: %s' );
define( '_MD_IMLINKS_LINKURLDSC', 'Кликните на иконку для открытия url в новой закладке или окне браузера.<br />Вы можете использовать это для проверки url.' );
