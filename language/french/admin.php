...
define( "_AM_IMLINKS_BRETURN", "Retourner d'où vous venez!" );
...
define( "_AM_IMLINKS_BUPDATE", "Mise à jour du module" );
...
define( "_AM_IMLINKS_VOTE_NOVOTES", "Pas de votes à afficher" );
...
define( "_AM_IMLINKS_BROKEN_DELETEDESC", "<b>Supprimer</b> les données du lien ainsi que le rapport de lien brisé." );
define( "_AM_IMLINKS_BROKEN_EDITDESC", "<b>Editer</b> le lien pour r&eacute;soudre le probl&eagrave;me." );
define( "_AM_IMLINKS_BROKEN_ACKDESC", "<b>Reconnaissance</b> Mettre le statut comme quoi il est reconnu que le lien est cassé." );
define( "_AM_IMLINKS_BROKEN_CONFIRMDESC", "<b>Confirmé</b> Mettre le satut comme quoi il est confirmé que le lien est cassé." );
define( "_AM_IMLINKS_BROKEN_ACKNOWLEDGED", "Reconnaissance" );
define( "_AM_IMLINKS_BROKEN_DCONFIRMED", "Confirmé" );
...
define( "_AM_IMLINKS_ICO_ACK", "Reconnaissance de rapport de lien brisé" );
define( "_AM_IMLINKS_ICO_REPORT", "Reconnaître le rappor de lien brisé ?" );
define( "_AM_IMLINKS_ICO_CONFIRM", "Rapport de lien brisé confirmé" );
define( "_AM_IMLINKS_ICO_CONBROKEN", "Confirmer le rapport de lien brisé ?" );
define( "_AM_IMLINKS_ICO_RES", "Editer les ressources/liens de cet élément" );
define( "_AM_IMLINKS_MOD_URLRATING", "Interent Content Rating:" );	// Inutilisé
// Alternate category
...
define( "_AM_IMLINKS_KEYWORDS", "Mots clés:" );
define( "_AM_IMLINKS_KEYWORDS_NOTE", "<i>Les mots clés doivent être séparés par une virgule (ex: Mot1, Mot2, Mot3).</i>" );
...
define( "_AM_IMLINKS_LINK_CHECKMAP", "Vérifier la carte" );
...
define( "_AM_IMLINKS_STATE", "Département" );
define( "_AM_IMLINKS_ZIPCODE", "Code Postal" );
define( "_AM_IMLINKS_TELEPHONE", "Téléphone" );
define( "_AM_IMLINKS_FAX", "Fax" );

// Version 1.05 RC2
define( "_AM_IMLINKS_WARNINSTALL4", "<b>WARNING:</b> <u>Le dossier</u> %s est fermé en écriture. <br />Le CHMOD 777 est requis pour ce dossier." );
// Version 1.05 RC5
define( "_AM_IMLINKS_VOIP", "VoIP" );
define( "_AM_IMLINKS_LINK_SUBMITTER", "Nom de l'auteur : " );
define( "_AM_IMLINKS_MOBILE", "Mobile" );
define( "_AM_IMLINKS_CATSPONSOR", "Sélectionner la catégorie du Sponsor:" );
define( "_AM_IMLINKS_CATSPONSORDSC", "Si vous sélectionnez un client, l'identifiant de la bannière indiqué dans le champ ci-dessous ne sera pas enregistré !" );
define( "_AM_IMLINKS_BANNER", "Bannière" );
define( "_AM_IMLINKS_FBANNER", "Bannière" );
define( "_AM_IMLINKS_BANNERID", "Sélectionner l'IDentifiant de la bannière:" );
define( "_AM_IMLINKS_BANNERIDDSC", "Si vous avez sélectionné un client, l'identifiant de la bannière indiqué dans le champ ci-dessous ne sera pas enregistré !" );
...
define( "_AM_IMLINKS_ICO_EXPIRE", "Expiré" );
...
// Version 1.06 RC1
define( "_AM_IMLINKS_READWRITEERROR", "Vous n'avez pas sélectionné un fichier à téléverser ou alors le serveur ne dispose pas des droits / CHMOD appropriés !" );
define( "_AM_IMLINKS_INVALIDFILESIZE", "Taille du fichier incorrecte" );
define( "_AM_IMLINKS_FILENAMEEMPTY", "Nom du fichier vide" );
define( "_AM_IMLINKS_NOFILEUPLOAD", "Aucun fichier téléversé, une erreur est survenue." );
define( "_AM_IMLINKS_UPLOADERRORZERO", "Une erreur est survenue. Erreur: 0" );
define( "_AM_IMLINKS_UPLOADERRORONE", "Le fichier que vous essayez de téléverser est trop volumineux. Erreur: 1" );
define( "_AM_IMLINKS_UPLOADERRORTWO", "Le fichier que vous essayez de téléverser est trop volumineux. Erreur: 2" );
define( "_AM_IMLINKS_UPLOADERRORTHREE", "Le fichier que vous essayez de téléverser est partiellement transmis. Erreur: 3" );
define( "_AM_IMLINKS_UPLOADERRORFOUR", "Aucun fichier sélectionné pour le téléversement. Erreur: 4" );
define( "_AM_IMLINKS_UPLOADERRORFIVE", "Aucun fichier sélectionné pour le téléversement. Erreur: 5" );
define( "_AM_IMLINKS_NOUPLOADDIR", "Le répertoire d'upload n'est pas correctement indiqué" );
define( "_AM_IMLINKS_FAILOPENDIR", "Impossible d'accéder au répertoire : " );
define( "_AM_IMLINKS_FAILOPENDIRWRITEPERM", "Impossible d'accéder au répertoire avec les permissions (CHMOD) : " );
define( "_AM_IMLINKS_FILESIZEMAXSIZE", "Taille du fichier : %u. Taille maximale autorisée : %u" );
define( "_AM_IMLINKS_FILESIZEMAXWIDTH", "Taille du fichier : %u. Taille maximale autorisée : %u" );
define( "_AM_IMLINKS_FILESIZEMAXHEIGHT", "Hauteur du fichier : %u. Hauteur maximale autorisée : %u" );
define( "_AM_IMLINKS_MIMENOTALLOW", "MIME type non autorisé : " );
define( "_AM_IMLINKS_FAILEDUPLOADING", "Impossible de charger le fichier : " );
define( "_AM_IMLINKS_FILE", "Le fichier " );
define( "_AM_IMLINKS_ALREADYEXISTTRYAGAIN", " existe déjà sur le serveur. Veuillez le renommer avant de le téléverser.<br />" );
define( "_AM_IMLINKS_ERRORSRETURNUPLOAD", "<h4>Erreurs durant le téléversement</h4>" );
...
define( "_AM_IMLINKS_ERROR_CATISCAT", "Vous ne pouvez pas définir une catégorie comme sous-catégorie d'elle-même !" );
define( "_AM_IMLINKS_MOD_COUNTRY", "Pays :" );
define( "_AM_IMLINKS_MOD_KEYWORDS", "Mots clés:" );
...
define( "_AM_IMLINKS_MOD_STATE", "Département :" );
define( "_AM_IMLINKS_MOD_ZIP", "Code postal :" );
define( "_AM_IMLINKS_MOD_TEL", "Téléphone :" );
...
// version 1.06 RC-2
define( "_AM_IMLINKS_IPAGE_SHOWLATEST", "Afficher les dernières entrées ?" );
define( "_AM_IMLINKS_IPAGE_LATESTTOTAL", "Nom de liens à afficher ?" );
define( "_AM_IMLINKS_IPAGE_LATESTTOTAL_DSC", "0 désactive cette fonction" );
