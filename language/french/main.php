...
define( "_MD_WFL_UPDATEDON", "Mis à jour le" );
...
define( "_MD_WFL_BEOBJECTIVE", "Veuillez &ecirc;tre objectif, si chacun reÃ§oit un 1 ou des 10, les estimations ne sont pas tr&egrave;s utiles." );
...
define( "_MD_WFL_KEYWORDS", "Mots clés: " );
define( "_MD_WFL_KEYWORDS_NOTE", "<i>Les mots clés doivent être séparés par une virgule (ex: Mot1, Mot2, Mot3).</i>" );
...
define( "_MD_WFL_ADDTO", "Ajouter à : " );
define( "_MD_WFL_INFORMATION", "Information" );
define( "_MD_WFL_ADDRESS", "Détails du contact:" );
...
define( "_MD_WFL_STATE", "Département" );
define( "_MD_WFL_ZIPCODE", "Code postal" );
define( "_MD_WFL_TELEPHONE", "Téléphone");
define( "_MD_WFL_TEL", "Tél. " );
...
define( "_MD_WFL_NOITEMSELECTED", "Vous n'avez pas sélectionner un lien valide !");
