...
define( "_AM_IMLINKS_PINGTIMES", "Mostrar los primeros ping time de cada enlace.<br /><br />Nota: Estos resultados pueden no ser exactos y se deben tomar como una referencia.<br /><br />" );
