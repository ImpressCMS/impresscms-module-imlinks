...
define( '_AM_IMLINKS_MINDEX_PAGEINFOTXT', '<ul><li>imLinks main page details.</li><li>You can easily change the image logo, heading, main index header and footer text to suit your own look</li></ul><br />Внимание: Выбранный логотип будет использован во всем модуле imLinks.' );
