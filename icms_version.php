...
$modversion['templates'][5]['file'] = 'imlinks_ratelink.html';
$modversion['templates'][5]['description'] = '';
$modversion['templates'][6]['file'] = 'imlinks_singlelink.html';
$modversion['templates'][6]['description'] = '';
$modversion['templates'][8]['file'] = 'imlinks_topten.html';
$modversion['templates'][8]['description'] = '';
$modversion['templates'][9]['file'] = 'imlinks_viewcat.html';
$modversion['templates'][9]['description'] = '';
$modversion['templates'][10]['file'] = 'imlinks_newlistindex.html';
$modversion['templates'][10]['description'] = '';
$modversion['templates'][11]['file'] = 'imlinks_print.html';
$modversion['templates'][11]['description'] = '';
$modversion['templates'][12]['file'] = 'imlinks_disclaimer.html';
...
$modversion['config'][$i]['title'] = '_MI_IMLINKS_SELECTFEED';
$modversion['config'][$i]['description'] = '_MI_IMLINKS_SELECTFEED_DSC';
$modversion['config'][$i]['formtype'] = 'yesno';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 1;
$i++;
$modversion['config'][$i]['name'] = 'rssfeedtotal';
$modversion['config'][$i]['title'] = '_MI_IMLINKS_FEEDSTOTAL';
$modversion['config'][$i]['description'] = '_MI_IMLINKS_FEEDSTOTALDSC';
$modversion['config'][$i]['formtype'] = 'textbox';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = '15';
$i++;
$modversion['config'][$i]['name'] = 'rssfeedlogo';
$modversion['config'][$i]['title'] = '_MI_IMLINKS_FEEDSLOGO';
$modversion['config'][$i]['description'] = '_MI_IMLINKS_FEEDSLOGODSC';
$modversion['config'][$i]['formtype'] = 'textbox';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = ICMS_URL . '/modules/' . $mydirname . '/images/imlinks_iconbig.png';
$i++;
