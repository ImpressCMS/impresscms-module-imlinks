...
define('_MODABOUT_IMLINKS_MODULE_BUG', 'Report a bug for this module');
...
define('_MODABOUT_IMLINKS_MODULE_SUPPORT', 'Official support site');
define('_MODABOUT_IMLINKS_UPDATE_MODULE', 'Update module');
define('_MODABOUT_IMLINKS_VERSION_HISTORY', 'Version History');
...
define('_MODABOUT_IMLINKS_PEOPLE_DOCUMENTERS', 'Documenters');
define('_MODABOUT_IMLINKS_PEOPLE_TRANSLATERS', 'Translators');
define('_MODABOUT_IMLINKS_PEOPLE_OTHER', 'Other contributors');
