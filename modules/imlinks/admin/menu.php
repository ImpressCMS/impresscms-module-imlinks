...
$adminmenu[1]['link']	= 'admin/links.php';
...
$adminmenu[2]['link']	= 'admin/links.php?op=edit';
...
if ( isset( icms::$module ) ) {
	...
	$headermenu[$i]['link']  = ICMS_URL . '/modules/' . basename( dirname( dirname( __FILE__ ) ) ) . '/admin/links.php?op=pingtime';
	$i++;
