...
* @since		1.00
* @author		McDonald
* @version		$Id: admin.php 23907 2012-03-19 17:36:34Z mcdonald3072 $ Russian translation. Charset: utf-8 (without BOM)
*/
...
define( "_AM_IMLINKS_LISTBROKEN", "Показаны ссылки, которые, возможно, являются сбойными. ВНИМАНИЕ: Этот результат может быть не совсем правильным.<br /><br />Пожалуйста, до принятия каких-либо действий проверьте ссылку на существование." );
define( "_AM_IMLINKS_PINGTIMES", "Показано время отклика на первый ping для каждой ссылки.<br /><br />ВНИМАНИЕ: Этот результат может быть не совсем правильным." );
