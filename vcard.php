...
Modified for imLinks by McDonald - March 2008
...
global $xoopsDB;
$result = $xoopsDB -> query( "SELECT title, street1, street2, town, zip, state, country, url, tel, fax, voip, mobile, email, vat FROM " . $xoopsDB -> prefix( 'imlinks_links' ) . " WHERE lid=" . intval( $lid ) );
